...
namespace VDM {
    ...
    public:
        ...
        const std::unordered_map<MonitorId, WorkspaceId>& getBindings() const { return m_workspaceByMonitor; }
         ...
         */
        std::string toStringDetailed(bool json = false, std::optional<bool> asNode = std::nullopt) const;
